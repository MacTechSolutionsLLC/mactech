# Security configuration settings - Evidence - CMMC Level 2
...
This document provides evidence of implementation for control 3.4.2: Security configuration settings.

**Implementation Status:** ✅ Implemented

**Original Reference:** MAC-RPT-121_3_4_2_security_configuration_settings_Evidence
