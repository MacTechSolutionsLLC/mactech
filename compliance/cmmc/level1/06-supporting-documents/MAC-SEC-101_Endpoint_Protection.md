# Endpoint Protection - CMMC Level 1
...
**Required:** Windows Defender (or equivalent) enabled with automatic updates
...
**Screenshot Evidence:** Windows Security dashboard showing protection enabled
...
- Updates via Windows Update service
...
- Antivirus Product: Windows Defender
