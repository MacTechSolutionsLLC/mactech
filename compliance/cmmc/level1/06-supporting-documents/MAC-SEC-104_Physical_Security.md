# Physical Security - CMMC Level 1
...
**Inherited Control:** Railway provides physical security for all cloud infrastructure, including:
- Data center physical access controls
- Environmental controls (temperature, humidity, fire suppression)
- Facility security (guards, surveillance, access logs)
- Redundant power and cooling systems

**Organization Responsibility:** Organization relies on Railway for physical security of cloud infrastructure. Organization does not claim responsibility for Railway's physical security posture.

**Evidence:** Railway platform documentation, `Inherited_Control_Statement_Railway.md`
...
- Physical Environment and Remote Work Controls (`../cmmc/level1/02-policies-and-procedures/MAC-SOP-224_Physical_Environment_and_Remote_Work_Controls.md`)
