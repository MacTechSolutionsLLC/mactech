...
This self-assessment documents the implementation status of all 17 CMMC Level 1 practices required by FAR 52.204-21. Each practice is assessed as **Implemented**, **Inherited**, or **Not Implemented**, with specific evidence locations referenced.
...
- Network security capabilities are relied upon operationally from Railway platform but are not independently assessed as part of this CMMC Level 1 self-assessment
...
**Implementation:**
- Database security capabilities are relied upon operationally from Railway PostgreSQL service but are not independently assessed as part of this CMMC Level 1 self-assessment
- Passwords hashed using bcrypt (12 rounds)
- FCI stored in Railway-managed database
- Evidence: Railway platform, `lib/password-policy.ts` (bcryptRounds: 12)

**Encryption Coverage:**
- Database storage: Security capabilities relied upon from Railway PostgreSQL (not independently assessed)
...
**Note:** Certain infrastructure-related practices are inherited from platform providers (Railway, GitHub); all organizational responsibilities are implemented internally.
...
**None.** All 17 CMMC Level 1 practices are either implemented or inherited.
...
| 10 | `app/admin/physical-access-logs/page.tsx`<br>`app/api/admin/physical-access-logs/route.ts`<br>Database: `PhysicalAccessLog` table | Physical access logging module |
...
- System & Information Integrity Policy (`02-policies-and-procedures/MAC-POL-214_System_Integrity_Policy.md`) - Authoritative version
