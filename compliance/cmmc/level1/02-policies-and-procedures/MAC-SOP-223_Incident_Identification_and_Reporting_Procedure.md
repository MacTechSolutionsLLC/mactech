# Incident Identification and Reporting Procedure - CMMC Level 1
...
**Note:** CMMC Level 1 does not require DoD or customer notification unless contractually required. The Security Contact determines if external notification is needed.
