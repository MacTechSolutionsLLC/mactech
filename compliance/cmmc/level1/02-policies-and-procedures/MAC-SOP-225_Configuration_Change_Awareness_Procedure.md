...
- Log in to Railway platform (for environment variables)
...
### 7.1 Railway Platform Environment Variables

**Access:**
- Log in to Railway platform
...
- Use Railway platform for secret management
