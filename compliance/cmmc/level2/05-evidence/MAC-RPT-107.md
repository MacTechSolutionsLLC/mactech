...
- Review logs stored in: `compliance/cmmc/level2/05-evidence/audit-log-reviews/audit-log-review-log.md`
- Export procedures documented for compliance reporting

**Evidence Generation:**
- Script: `scripts/generate-evidence.ts` - Generates audit log exports
- Sample exports: `compliance/cmmc/level2/05-evidence/sample-exports/`
