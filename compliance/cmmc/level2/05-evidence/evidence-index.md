...
This document provides a comprehensive index of all evidence objects for CMMC Level 2 compliance, including where to find them and how to generate them.
...
**Location:** `compliance/cmmc/level2/02-policies-and-procedures/`
...
**Location:** `compliance/cmmc/level2/04-self-assessment/`
...
**Location:** `compliance/cmmc/level2/01-system-scope/`
...
**Location:** `compliance/cmmc/level2/03-control-responsibility/` and `05-evidence/provider/`
...
**Location:** `compliance/cmmc/level2/05-evidence/sample-exports/`
...
**Location:** `compliance/cmmc/level2/05-evidence/templates/`
...
**Location:** `compliance/cmmc/level2/05-evidence/endpoint-verifications/` and `vulnerability-remediation/`
...
**Location:** `compliance/cmmc/level2/05-evidence/provider/railway/` and `provider/github/`
