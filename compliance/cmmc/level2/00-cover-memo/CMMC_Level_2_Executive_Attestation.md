...
**INTERNAL REFERENCE – NOT FOR SUBMISSION**

This document is maintained for internal reference only. The authoritative Executive Attestation is `MAC-FRM-202_CMMC_Level_2_Executive_Attestation.md`.
...
**All 110 NIST SP 800-171 Rev. 2 controls required for CMMC Level 2 are implemented, inherited, or tracked in POA&M** in the MacTech Solutions system in accordance with CMMC 2.0 Level 2 (Advanced) requirements.

This attestation is based on:
- Comprehensive self-assessment of all 110 CMMC Level 2 controls aligned to NIST SP 800-171 Rev. 2
...
I attest that the following 17 CMMC Level 1 practices aligned to FAR 52.204-21 are implemented:
...
12. ✅ Use encryption for FCI in transit (Note: Practice originally written for CUI; applied to FCI in this system. System does not process, store, or transmit CUI)
13. ✅ Use encryption for FCI at rest (Note: Practice originally written for CUI; applied to FCI in this system. System does not process, store, or transmit CUI)
...
1. **System Description** (`01-system-scope/system-description.md`)
2. **FCI Scope and Data Boundary Statement** (`01-system-scope/FCI_Scope_and_Data_Boundary_Statement.md`)
...
4. **Control Responsibility** (`03-control-responsibility/`)
   - Inherited Controls Responsibility Matrix
   - Inherited Control Statement Railway
...
- System Description (`01-system-scope/system-description.md`)
