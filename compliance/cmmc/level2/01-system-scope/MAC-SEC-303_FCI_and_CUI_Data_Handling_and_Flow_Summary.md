...
- All connections use HTTPS/TLS encryption (inherited from Railway platform)
...
- Database encryption at rest (security capabilities relied upon from Railway, not independently assessed)
...
**Location:** PostgreSQL database on Railway platform  
**Encryption:** Database security capabilities relied upon from Railway platform (not independently assessed)  
...
- Connection security provided by Railway platform
...
- Database security capabilities (relied upon from Railway)
...
- Cloud infrastructure physical security (inherited from Railway)
- No local device storage of FCI
