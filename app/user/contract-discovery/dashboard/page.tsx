          ...
          <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
            ...
            {loading ? (
              ...
              <div className="bg-white rounded-2xl shadow-lg shadow-neutral-200/50 border border-neutral-100 p-16 text-center">
                ...
                <Link href="/user/contract-discovery" className="inline-block px-6 py-3 bg-accent-700 text-white rounded-xl text-sm font-medium hover:bg-accent-800 transition-all shadow-md shadow-accent-700/20">
