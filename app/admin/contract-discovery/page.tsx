...
const SEARCH_TEMPLATES: SearchTemplate[] = [
  {
    ...
    query: 'site:sam.gov -filetype:pdf contract opportunity SDVOSB Set-Aside RMF cybersecurity',
  ...
  },
  {
    ...
    query: 'site:sam.gov -filetype:pdf solicitation SDVOSB Sole Source RMF',
  ...
  },
  {
    ...
    query: 'site:sam.gov -filetype:pdf notice VOSB Department of Veterans Affairs RMF',
  ...
  },
  {
    ...
    query: 'site:sam.gov -filetype:pdf contract opportunity SDVOSB ISSO ISSM',
  ...
  },
  {
    ...
    query: 'site:sam.gov -filetype:pdf solicitation SDVOSB eMASS ATO',
  ...
  },
  {
    ...
    query: 'site:sam.gov -filetype:pdf notice SDVOSB "NIST 800-53" SCA',
  ...
  },
  {
    ...
    query: 'site:sam.gov -filetype:pdf contract opportunity SDVOSB NAICS 541512 RMF',
  ...
  },
  {
    ...
    query: 'site:sam.gov -filetype:pdf solicitation HACS SDVOSB RMF',
  ...
  },
  {
    ...
    query: 'site:sam.gov -filetype:pdf contract opportunity RMF ATO',
  ...
  },
  {
    ...
    query: 'site:sam.gov -filetype:pdf solicitation STIG cybersecurity',
  ...
  },
  {
    ...
    query: 'site:sam.gov -filetype:pdf notice "NIST 800-53" security controls',
  ...
  },
  {
    ...
    query: 'site:sam.gov -filetype:pdf contract opportunity "Department of Defense" RMF',
  ...
  },
  {
    ...
    query: 'site:sam.gov -filetype:pdf solicitation "Continuous Monitoring" ConMon',
