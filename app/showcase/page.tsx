...
const tools: Tool[] = [
  {
    ...
    // launchUrl: process.env.NEXT_PUBLIC_STIG_GENERATOR_URL || 'http://localhost:4000', // Disabled
    deliverables: {
  ...
  // Infrastructure Domain - James Adams
  {
    ...
    // launchUrl: '/tools/data-center-deployment', // Disabled
    deliverables: {
  ...
  },
  {
    ...
    // launchUrl: '/tools/infrastructure-health-monitoring', // Disabled
    deliverables: {
  ...
  },
  {
    ...
    // launchUrl: '/tools/network-config-automation', // Disabled
    deliverables: {
  ...
  // Quality Assurance Domain - Brian MacDonald
  {
    ...
    // launchUrl: '/tools/iso-compliance-platform', // Disabled
    deliverables: {
  ...
  },
  {
    ...
    // launchUrl: '/tools/sop-automation-module', // Disabled
    deliverables: {
  ...
  },
  {
    ...
    // launchUrl: '/tools/metrology-management', // Disabled
    deliverables: {
  ...
  },
  {
    ...
    // launchUrl: '/tools/audit-readiness-platform', // Disabled
    deliverables: {
  ...
  // Legal & Contracts Domain - John Milso
  {
    ...
    // launchUrl: '/tools/contract-management-platform', // Disabled
    deliverables: {
  ...
  },
  {
    ...
    // launchUrl: '/tools/legal-document-generation', // Disabled
    deliverables: {
  ...
  },
  {
    ...
    // launchUrl: '/tools/contract-risk-analysis', // Disabled
    deliverables: {
  ...
  // Cybersecurity & RMF Domain - Patrick Caruso
  {
    ...
    // launchUrl: '/tools/rmf-requirements-management', // Disabled
    deliverables: {
  ...
  },
  {
    ...
    // launchUrl: '/tools/security-architecture', // Disabled
    deliverables: {
  ...
  },
  {
    ...
    // launchUrl: '/tools/vulnerability-compliance', // Disabled
    deliverables: {
  ...
  },
  {
    ...
    // launchUrl: '/tools/security-documentation', // Disabled
    deliverables: {
  ...
  },
  {
    ...
    // launchUrl: '/tools/cybersecurity-team-leadership', // Disabled
    deliverables: {
  ...
  // Compliance & Security Domain - Shared
  {
    ...
    // launchUrl: '/tools/stig-compliance-validation', // Disabled
    deliverables: {
  ...
  },
  {
    ...
    // launchUrl: '/tools/evidence-collection', // Disabled
    deliverables: {
  ...
  },
  {
    ...
    // launchUrl: '/tools/rmf-artifacts', // Disabled
    deliverables: {
  ...
  // Support Automation Domain - Shared
  {
    ...
    // launchUrl: '/tools/ticket-routing-platform', // Disabled
    deliverables: {
  ...
  },
  {
    ...
    // launchUrl: '/tools/knowledge-base-automation', // Disabled
    deliverables: {
        ...
        <div className="max-w-6xl mx-auto">
          ...
          {viewMode === 'pillar' && activeTools.length > 0 && (
            <div className={`mb-8 p-6 rounded-lg border-2 ${pillarInfo[activeTab as Pillar].color}`}>
              <h2 className="heading-2 mb-2">{pillarInfo[activeTab as Pillar].name} Modules</h2>
                  ...
                  >
                    ...
                    {isExpanded && (
                      <div className="px-6 pb-6 border-t border-neutral-200 pt-6 space-y-6">
                        {/* Use Tool Button - Temporarily disabled */}
                        {false && tool.status === 'available' && tool.launchUrl && (
